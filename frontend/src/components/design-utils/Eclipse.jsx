  ...
  return (
    ...
    >
      <div className="relative flex justify-center bg-black items-center w-full h-full">
        {/* Gradient Circle */}
        <div className="absolute z-[1]  rounded-full w-[80%] h-[80%] bg-gradient-to-r from-[rgba(53,124,247,1)] to-[rgba(110,73,242,1)] flex justify-center items-center">
          {/* Inner Black Circle */}
          <div className="w-[90%]  h-[90%] bg-black rounded-full"></div>
        </div>
        {/* Blurred Backdrop */}
